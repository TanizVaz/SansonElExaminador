...
<%@include file="messages.frame.jsp" %>	<header>
		...
		<img src="img/persona.png" align="center" class="img-rounded" alt="id" width="180" height="170">
				...
				<div class="list-group">
					...
					<a href="participanteEventos.jsp" class="list-group-item active">Eventos</a>
				...
				<section class="main row">
					<article class="col-md-9">
 	 				 <h2 class="post-contenido text-justify">
 	 					 A continuaci&#243;n se presentan los eventos a los que solicitaste unirte y el estado de los mismos.
 	 				 </h2>
 					 	</article>
						<br> <br> <br> <br> <br>
							<br> <br><br> <br> <br>
					 ...
					 <div class="row">
						 ...
						 <div class="col-md-2"> <p>Estado del evento </p>
							 <a href="#" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span>  Aceptado</a>
						 </div>
		...
		<!--	 <div class="container">
  <h2>Eventos Seleccionados</h2>
  <p>Consulte el estado de los eventos a los que pidi&#243; unirse.</p>
